...
# -*- coding: utf-8 -*-
#
# Doc_as_Code_Tools-Documents documentation build configuration file, created by
...
"""This script is used to set the configuration to build e2e manual and to publish documents to
confluence

- author: Veeresh Katageri
- status: alpha
- e-mail: veeersh.katageri@efs-auto.de
"""
...
path_plantuml = os.path.join(os.path.dirname(path_plantuml), 'tools', 'plantuml.jar')
...
def find_exclude_patterns():
    ...
    # Define field names
    fieldnames = ['file_name', 'generate_html', 'publish_confluence']
    ...
    for file_include_list in list_csv_include_lists:
        if os.path.exists(file_include_list):
            ...
            with open(file_include_list) as csv_file:
                ...
                # Skip first line
                row = next(csv_reader)
                # Read columns 'publish_confluence' or 'generate_html' based on DOCU_GENERATION_TYPE
...
project = 'Doc as code Toolchain Documentation'
copyright = '2020'
...
if DOCU_GENERATION_TYPE == 'publish_confluence':
    ...
    confluence_server_user = os.environ.get('CI_TECH_USER_KITT')
    confluence_server_pass = os.environ.get('CI_TECH_PWD_KITT')
...
man_pages = [
    (master_doc, 'Doc_as_Code_Tools-Documents', 'Doc_as_Code_Tools-Documents Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Doc_as_Code_Tools-Documents', 'Doc_as_Code_Tools-Documents Documentation',
     author, 'Doc_as_Code_Tools-Documents', 'One line description of project.',
     'Miscellaneous'),
]
