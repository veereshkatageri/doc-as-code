...
# -*- coding: utf-8 -*-
#
# SiANOMTech_Tools-Documents documentation build configuration file, created by
...
path_plantuml = os.path.join(path_plantuml, 'tools', 'plantuml.jar')
...
def find_exclude_patterns():
    ...
    # Define field names
    fieldnames = ['file_name', 'upload_e2e', 'publish_confluence']
    ...
    for file_include_list in list_csv_include_lists:
        if os.path.exists(file_include_list):
            ...
            list_unwanted = ['documents', 'images', 'IncludeLists.csv', 'conf.py']
            ...
            with open(file_include_list) as csv_file:
                ...
                # Skip first line
                row = next(csv_reader)
                # Read columns 'publish_confluence' or 'upload_e2e' based on DOCU_GENERATION_TYPE
...
project = 'SiANOMTech Technical-Documents'
copyright = '2020, SiANOMTech'
author = 'SiANOMTech'
...
if DOCU_GENERATION_TYPE == 'publish_confluence':
    # if it is jenkins job then, Username and passoword will be substitued by Jenkins system user credentials during switching mechanism
    ...
    if confluence_server_user is not None and confluence_server_pass is not None:
        ...
        try:
            ...
            # Default space name is EX00059 and it set by conanfile.py
            confluence_space_name = os.environ.get('CONFLUENCE_SPACE_NAME')
            # Default server url is yet to be deciced and it set by conanfile.py
...
latex_documents = [
    (master_doc, 'SiANOMTech_Tools-Documents.tex', 'SiANOMTech_Tools-Documents Documentation',
     'Generated by SiANOMTech Toolchain', 'manual'),
]
...
man_pages = [
    (master_doc, 'SiANOMTech_Tools-Documents', 'SiANOMTech_Tools-Documents Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SiANOMTech_Tools-Documents', 'SiANOMTech_Tools-Documents Documentation',
     author, 'SiANOMTech_Tools-Documents', 'One line description of project.',
     'Miscellaneous'),
]
